...
<head>
  ...
  <title>MANUEL SCORZA TORRES</title>
  <!-- plugins:css -->
  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo mr-5" href="../d.php"><img src="../img/logo1.png
                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputName1" value="<?=$filas['nombre']?> <?=$filas['apellido']?>">
                    </div>
                    <div class="form-group">
