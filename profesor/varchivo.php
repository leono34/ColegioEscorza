                ...
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    ...
                    <table class="table table-hover">
                      ...
                      <tbody>
                            <?php 
                            $consulta="SELECT u.NomUsuario,u.ApellidoUsuario ,c.NomCurso ,a.Ruta 
                            FROM archivo a,usuario u,tb_curso c WHERE a.IdDocente=u.CodUsuario 
                            AND c.idCurso=u.tipCurso and CodUsuario='$id'";
                            $resultado=mysqli_query($conec,$consulta);
                            while ($filas=mysqli_fetch_array($resultado)){
                            ?>
                              <tr>
